    ...
    <Navbar className="py-0" expand="lg">
      <Container className={`${navStyles.navWrapper} px-3 py-2 rounded w-50`}>
        ...
        <Navbar.Collapse className="justify-content-end" id="basic-navbar-nav">
          <Nav className="">
            <Nav.Link className={`${btnStyles.btnWrapper} rounded`} onClick={onAboutClick}>
              <span></span>
              <span></span>
              <span></span>
              <span></span>
            ...
            <Nav.Link className={`${btnStyles.btnWrapper}  rounded`} onClick={onSkillsClick}>
              <span></span>
              <span></span>
              <span></span>
              <span></span>Skills
            </Nav.Link>
            <Nav.Link className={`${btnStyles.btnWrapper} rounded`} onClick={onPortofoliosClick}>
              <span></span>
              <span></span>
              <span></span>
              <span></span>
            ...
            <Nav.Link className={`${btnStyles.btnWrapper} rounded`} onClick={onContactClick}>
              <span></span>
              <span></span>
              <span></span>
              <span></span>
